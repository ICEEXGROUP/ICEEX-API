using ICEEX.WebsocketConsle.Models;
using ICEEX.WebsocketConsle.Util;
using ICEEX.WebsocketConsle.WebSocketSharp;
...
namespace ICEEX.WebsocketConsle
{
    class Program
    {
        private readonly static string URL = "ws://real.ICEEX.io:10330/websocket";
