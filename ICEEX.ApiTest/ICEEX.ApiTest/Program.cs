using ICEEX.ApiTest.HttpTools;
using ICEEX.ApiTest.Models;
using ICEEX.ApiTest.Models.InputModels;
using ICEEX.ApiTest.Models.OutputModels;
using System;
using Newtonsoft.Json;
using ICEEX.ApiTest.Signs;
using System.Threading.Tasks;
using System.Collections.Generic;
using ICEEX.ApiTest.Extensions;
using Xunit;

namespace ICEEX.ApiTest
{
    class Program
    {
        private readonly static string host = "http://preapi.ICEEX.io:8303";
